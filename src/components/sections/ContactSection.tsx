...
function ContactSection({ copy }: ContactSectionProps) {
  return (
    <section className="section-y" id="contact">
      <div className="reveal container grid items-center gap-6 md:grid-cols-[1.1fr_0.9fr]">
        <SectionHeading
        ...
        <div className="rounded-panel border border-black/10 bg-[linear-gradient(135deg,rgba(69,139,201,0.06),rgba(31,79,120,0.03)),rgba(255,255,255,0.88)] p-8 shadow-panel">
          <p className="text-[0.78rem] font-bold uppercase tracking-[0.12em] text-brand-deep">
            {copy.contact.emailLabel}
          </p>
          <a
            className="mt-2 inline-block font-display text-[clamp(1.5rem,4vw,2.3rem)] font-bold tracking-[-0.03em] text-ink"
