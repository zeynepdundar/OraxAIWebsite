              ...
              <div className="absolute bottom-0 right-0 z-10 h-[80%] w-[80%]">
                <div className="relative h-full w-full">
                  <img
                    ...
                    className="h-full w-full rounded-2xl border border-gray-200 object-cover shadow-xl"
                  />
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-8 text-white">
                    ...
                    <h2 className="mt-2 max-w-[14ch] text-[clamp(2.1rem,4vw,3.1rem)] tracking-[-0.045em]">
                      {copy.hero.text}
                    </h2>
                    ...
                    <div className="mt-5 flex flex-wrap gap-3">
                      {copy.hero.features.map((feature) => (
                        <span
                          key={feature}
                          className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm text-white backdrop-blur-sm"
                        >
                          {feature}
                        </span>
                      ))}
